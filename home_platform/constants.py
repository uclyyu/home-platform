...
MODEL_CATEGORY_COLOR_MAPPING = {
    'ATM': [153, 204, 102],
    'accordion': [153, 102, 51],
    'air_conditioner': [51, 255, 204],
    'amplifier': [153, 255, 51],
    'arch': [102, 204, 204],
    'armchair': [153, 0, 102],
    'baby_bed': [51, 153, 0],
    'basketball_hoop': [0, 102, 102],
    'bathtub': [51, 0, 153],
    'beer': [255, 255, 102],
    'bench_chair': [0, 51, 255],
    'bicycle': [204, 255, 0],
    'book': [102, 255, 255],
    'books': [255, 0, 255],
    'bookshelf': [255, 204, 0],
    ...
    'cart': [255, 153, 102],
    'ceiling': [153, 204, 204],
    'ceiling_fan': [102, 255, 204],
    'cellphone': [204, 102, 0],
    'chair': [0, 0, 153],
    'chair_set': [0, 204, 102],
    'chandelier': [204, 0, 255],
    'chessboard': [102, 255, 102],
    'clock': [153, 0, 153],
    'cloth': [153, 102, 204],
    'coffee_kettle': [102, 0, 255],
    'coffee_machine': [51, 204, 255],
    'coffee_table': [0, 0, 255],
    'coffin': [0, 255, 204],
    'column': [102, 51, 0],
    'computer': [204, 51, 153],
    'container': [153, 153, 255],
    'containers': [204, 204, 51],
    'cooker': [102, 51, 204],
    'cup': [153, 204, 153],
    'curtain': [255, 0, 153],
    'cutting_board': [255, 153, 153],
    'decoration': [51, 102, 255],
    'desk': [204, 255, 153],
    'dining_table': [0, 153, 102],
    'dishwasher': [153, 153, 102],
    'door': [153, 255, 153],
    'double_bed': [0, 0, 51],
    'dresser': [51, 255, 0],
    'dressing_table': [153, 204, 0],
    'drinkbar': [0, 102, 153],
    'drumset': [255, 51, 153],
    'dryer': [0, 204, 255],
    'empty': [51, 51, 153],
    'fence': [255, 0, 0],
    'fireplace': [255, 0, 51],
    'fish_tank': [102, 102, 102],
    'fishbowl': [102, 204, 102],
    'floor': [51, 51, 204],
    'floor_lamp': [204, 102, 153],
    'food': [0, 51, 153],
    'food_processor': [255, 204, 51],
    'food_tray': [51, 0, 0],
    'fork': [102, 153, 0],
    'fruit_bowl': [204, 0, 204],
    'game_table': [204, 153, 204],
    'garage_door': [255, 102, 102],
    'glass': [204, 204, 204],
    'goal_post': [51, 204, 153],
    'gramophone': [153, 0, 0],
    'grill': [255, 255, 204],
    'guitar': [204, 153, 102],
    'gym_equipment': [153, 255, 204],
    'hair_dryer': [102, 204, 153],
    'hanger': [51, 153, 204],
    'hanging_kitchen_cabinet': [255, 153, 204],
    'headphones_on_stand': [51, 204, 102],
    'headstone': [51, 204, 51],
    'heater': [153, 0, 255],
    'helmet': [204, 204, 0],
    'household_appliance': [204, 0, 102],
    'ipad': [204, 204, 153],
    'iron': [153, 204, 51],
    'ironing_board': [204, 51, 255],
    'jug': [102, 102, 51],
    'kettle': [0, 51, 102],
    'keyboard': [255, 0, 204],
    'kitchen_cabinet': [0, 51, 0],
    'kitchen_set': [51, 0, 102],
    'knife': [51, 255, 51],
    'knife_rack': [0, 153, 153],
    'ladder': [153, 255, 255],
    'laptop': [102, 204, 0],
    'lawn_mower': [51, 153, 153],
    'loudspeaker': [0, 255, 0],
    'magazines': [153, 255, 0],
    'mailbox': [204, 0, 0],
    'microphone': [0, 0, 0],
    'microwave': [51, 255, 102],
    'mirror': [0, 153, 0],
    'mortar_and_pestle': [204, 255, 102],
    'motorcycle': [102, 51, 255],
    'office_chair': [102, 153, 153],
    'ottoman': [51, 204, 0],
    'outdoor_lamp': [0, 102, 255],
    'outdoor_seating': [0, 204, 153],
    'outdoor_spring': [153, 51, 153],
    'pan': [0, 0, 204],
    'partition': [51, 153, 51],
    'pedestal_fan': [102, 0, 204],
    'person': [153, 255, 102],
    'pet': [51, 102, 204],
    'piano': [51, 0, 51],
    'picture_frame': [0, 255, 153],
    'pillow': [153, 51, 51],
    'place_setting': [51, 51, 0],
    'plant': [102, 51, 102],
    'plates': [153, 204, 255],
    'playstation': [153, 102, 0],
    'poker_chips': [51, 153, 102],
    'pool': [0, 51, 204],
    'range_hood': [102, 0, 102],
    'range_hood_with_cabinet': [51, 51, 255],
    'range_oven': [255, 102, 204],
    'range_oven_with_hood': [255, 51, 204],
    'refrigerator': [153, 0, 204],
    'rifle_on_wall': [102, 204, 255],
    'roof': [153, 102, 255],
    'rug': [204, 51, 204],
    'safe': [0, 153, 51],
    'shelving': [51, 255, 153],
    'shoes': [0, 255, 255],
    'shoes_cabinet': [153, 153, 51],
    'shower': [204, 204, 255],
    'single_bed': [51, 153, 255],
    'sink': [153, 153, 153],
    'slot_machine': [204, 153, 255],
    'slot_machine_and_chair': [204, 153, 51],
    'soap_dish': [255, 51, 0],
    'soap_dispenser': [204, 102, 204],
    'sofa': [204, 51, 102],
    'spoon': [204, 51, 51],
    'stairs': [255, 204, 255],
    'stand': [51, 0, 204],
    'stationary_container': [51, 51, 102],
    'stereo_set': [153, 51, 204],
    'storage_bench': [255, 102, 0],
    'surveillance_camera': [153, 51, 102],
    'switch': [255, 255, 255],
    'table': [204, 255, 204],
    'table_and_chair': [153, 153, 0],
    'table_lamp': [0, 102, 51],
    'teapot': [204, 255, 255],
    'telephone': [255, 204, 153],
    'television': [204, 255, 51],
    'theremin': [51, 255, 255],
    'toaster': [51, 102, 102],
    'toilet': [102, 255, 153],
    'toilet_paper': [0, 204, 204],
    'toilet_plunger': [153, 153, 204],
    'toiletries': [51, 102, 51],
    'towel_hanger': [102, 102, 204],
    'towel_rack': [0, 153, 255],
    'toy': [102, 204, 51],
    'trash_can': [255, 51, 51],
    'tricycle': [204, 102, 51],
    'trinket': [255, 102, 255],
    ...
    'umbrella': [51, 204, 204],
    'unknown': [204, 0, 153],
    'utensil_holder': [0, 255, 102],
    'vacuum_cleaner': [102, 51, 51],
    'vase': [255, 204, 102],
    'wall': [102, 153, 255],
    'wall_lamp': [255, 153, 255],
    'wardrobe_cabinet': [255, 0, 102],
    'washer': [255, 255, 153],
    'water_dispenser': [102, 153, 102],
    'weight_scale': [255, 255, 51],
    'whiteboard': [102, 255, 51],
    'window': [255, 51, 102],
    'wood_board': [51, 102, 153],
    'workplace': [204, 102, 102],
    'xbox': [102, 153, 51]
}
